...
{
    /// <inheritdoc />
    public partial class Add_VetAppointments_And_HealthRecords : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthRecords_PetId_RecordDateUtc",
                table: "HealthRecords",
                columns: new[] { "PetId", "RecordDateUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_VetAppointments_PetId_StartUtc",
                table: "VetAppointments",
                columns: new[] { "PetId", "StartUtc" });
        }
